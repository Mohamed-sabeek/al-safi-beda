      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 text-center">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-3 px-5 py-2 bg-secondary/10 border border-secondary/20 rounded-full text-secondary font-bold text-sm mb-8"
          >
          ...
          <p className="text-white/80 text-lg md:text-2xl mb-12 max-w-2xl leading-relaxed">
